...
<body>
    <header>
        <div class="hd-menu">
            <div class="logo-con">
                <span><a href="../index.html" class="logo-con-link">旅行はここ</a></span>
            </div>
            <div class="func_con">
                <div class="ordersearch-btn"><a href="../Member/mypage.html">予約照会・変更・キャンセル</a></div>
        ...
        <div class="nav-con">
            <ul><!--後でNav押したらActive状態にさせ、bg-colorが適用されるように-->
                <li class="nav-item" id="nav-hotel"><a href="./hotel_list.html" >ホテル</a></li>
...
<!--このようにするのかわからない。。。-->
<script type="text/javascript" src="../js/hotel_list.js" charset="UTF-8"></script>
