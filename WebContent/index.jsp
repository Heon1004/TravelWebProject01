...
<header>
    <div class="hd-menu">
        <div class="logo-con">
            <span><a href="./index.jsp" class="logo-con-link">旅行はここ</a></span>
        </div>
        <div class="func_con">
            <div class="ordersearch-btn"><a href="CustomerController?display=mypage">予約照会・変更・キャンセル</a></div>
    ...
    <div class="nav-con">
        <ul><!--後でNav押したらActive状態にさせ、bg-colorが適用されるように-->
            <li class="nav-item"><a href="./WEB-INF/Hotel/hotel_list.jsp"  >ホテル</a></li>
        ...
        <div class="home-con">
            ...
            <div class="home-search-con">
                <div class="search-tap">
                    ...
                    <div class="search-list"><button type="button" class="tab-link"onclick="searchTap(event, 'rentcar-tap');setairDate();">レンタカー</button></div>
                </div>
